...
btn_open_paren = tk.Button(root, text="(", command=lambda: add_to_calculation("("), width=5, font=("Times New Roman, 14"));
btn_open_paren.grid(row=5, column=1);

btn_close_paren = tk.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, font=("Times New Roman, 14"));
btn_close_paren.grid(row=5, column=3);

btn_clear = tk.Button(root, text="C", command=clear_field, width=11, font=("Times New Roman, 14"));
btn_clear.grid(row=6, column=1, columnspan=2);

btn_equals = tk.Button(root, text="=", command=eval_calculation, width=11, font=("Times New Roman, 14"));
